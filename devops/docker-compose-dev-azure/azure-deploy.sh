...
resourcename="crm8"  # lower case, only
resourcegroup="crm8_rg"
...
# git clone https://github.com/apilogicserver/crm8.git
# cd crm8
...
az group create --name crm8_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group crm8_rg --sku S1 --is-linux
az container create --resource-group crm8_rg --name crm8 --image apilogicserver/crm8:latest --dns-name-label crm8 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//crm8.westus.azurecontainer.io:5656'
