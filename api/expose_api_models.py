...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Contact, method_decorators= method_decorators)
    api.expose_object(database.models.CustomerInteraction, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.ProductVendor, method_decorators= method_decorators)
